...
summary: "Introducing StoryIQ: the IQ-suite approval workflow that turns a Product Owner's signal into an immutable Pass Record across 7 stages of PO, Dev, and QA."
...
### What is StoryIQ?
StoryIQ is the IQ-suite approval workflow that turns a Product Owner's signal into a verified, immutably recorded outcome. It sits between IdeaIQ, where opportunities are explored, and [SquadIQ](/blog/squadiq-delivery-os), where the active work board lives.

### What is a Pass Pack?
It is the evidence object every story must carry before leaving Self Check: what changed in plain language, a primary link to the canonical artifact, every self-check marked done, and at least one proof. When the PO clicks *Pass Story*, the whole pack is hashed and frozen as an immutable Pass Record.
...
### Who is StoryIQ for?
Product Owners who need an honest answer to *"what shipped this week?"*, engineering leads tired of evidence living in Slack threads, QA teams that want a fixed verdict object, and audit functions that need a record they can trust. It sits alongside the rest of my [projects](/projects) — and if that sounds like your team, [get in touch](/contact).
