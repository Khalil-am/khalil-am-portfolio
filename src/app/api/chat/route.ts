...
export async function POST(req: Request) {
  try {
    ...
    const fullMessages = [systemMessage, ...chatHistory, new HumanMessage(latestMessage)];
    ...
    return Response.json({ error: "Failed to process chat request. Please try again." }, { status: 500 });
  }
}
