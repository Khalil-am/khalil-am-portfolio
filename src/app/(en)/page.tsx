      ...
      <section className="flex flex-col items-start gap-8 md:flex-row-reverse md:items-center md:justify-between">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-4 font-light">
            Product and AI leader heading product management across a large,
            multi-entity government and enterprise portfolio in the GCC.
          </p>
          <p className="mt-2 font-light">
            I turn enterprise strategy into shipped products through AI-enabled
            discovery, strong governance, and cross-functional leadership. My
            background spans product ownership, business analysis, business
            intelligence, and data science across government, healthcare, and
            fintech.
          </p>
          <div className="mt-4 flex items-end gap-1">
            <p className="font-semibold">
              Reach out to learn more about my expertise
            </p>
